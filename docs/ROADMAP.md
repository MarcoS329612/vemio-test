...
- [ ] Unit tests for leakage-sensitive helpers (temporal splits, panel construction) —
      deferred until those helpers exist (Phase 2)
...
- [x] **B**: log-log demand model + range-guarded simulator → `reports/04_elasticity.md`
- [x] **C**: nine episodes, dual counterfactual, margin verdict → `reports/05_uplift.md`
- [ ] Decision records for model family, metric and uplift strategy — **the reasoning is
      written into the stage reports; extracting it into DRs is the outstanding
      documentation debt from this phase**
...
- [x] [Five business recommendations](../reports/business-recommendations.md), non-technical
